#!/usr/bin/env python3
"""
AI translation for Phase 2: AI-Detected Issues (38 strings)
Uses the same successful approach from Phase 1 with JSON Schema.
"""
...
**Category Context:** AI-Detected Issues - These are issues detected by AI analysis requiring ARIA markup, focus management, and proper semantic structure
...
def main():
    ...
    # Load template
    template_file = 'phase2_translation_template.json'
    ...
    # Process in batches
    batch_size = 15  # Same successful size from Phase 1
    all_translated = []
    ...
    for i in range(0, len(entries), batch_size):
        ...
        translated = translate_batch(client, batch, 'AI-Detected Issues')
    ...
    # Save results
    output_file = 'phase2_translated.json'
    output_data = {
        'metadata': {
            'phase': 2,
