#!/usr/bin/env python3
"""
AI translation for Phase 4: Landmarks (139 strings)
...
**Category Context:** Landmarks - ARIA landmark regions that help users navigate page structure
...
def main():
    ...
    # Load template
    template_file = 'phase4_translation_template.json'
    ...
    for i in range(0, len(entries), batch_size):
        ...
        translated = translate_batch(client, batch, 'Landmarks')
    ...
    # Save results
    output_file = 'phase4_translated.json'
    output_data = {
        'metadata': {
            'phase': 4,
            'name': 'Landmarks',
