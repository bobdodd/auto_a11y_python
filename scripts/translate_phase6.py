#!/usr/bin/env python3
"""
AI translation for Phase 6: All Remaining (288 strings)
...
**Category Context:** All Remaining - ARIA landmark regions that help users navigate page structure
...
def main():
    ...
    # Load template
    template_file = 'phase6_translation_template.json'
    ...
    for i in range(0, len(entries), batch_size):
        ...
        translated = translate_batch(client, batch, 'All Remaining')
    ...
    # Save results
    output_file = 'phase6_translated.json'
    output_data = {
        'metadata': {
            'phase': 4,
            'name': 'All Remaining',
