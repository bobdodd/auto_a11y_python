...
def parse_template():
    ...
    template_path = Path(__file__).parent.parent / 'ISSUE_CATALOG_TEMPLATE.md'
    ...
    for match in re.finditer(pattern, content, re.MULTILINE):
        ...
        why_matters = match.group(7).strip()
        who_affects = match.group(8).strip()
        ...
        # Parse WCAG into a list
        if wcag and wcag != 'N/A':
            wcag_list = [w.strip() for w in wcag.split(',')]
        else:
            wcag_list = []
...
def main():
    ...
    print("Parsing ISSUE_CATALOG_TEMPLATE.md...")
