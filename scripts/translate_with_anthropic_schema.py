#!/usr/bin/env python3
"""
AI translation using Anthropic Claude API with JSON Schema for structured output.

This version uses the response_format parameter to ensure valid JSON responses,
...
def main():
    ...
    batch_size = 15  # Reduced from 75 for higher success rate
    all_translated = []
    ...
    print(f"\nTranslating {len(entries)} strings in batches of {batch_size} (with JSON schema)...")
    print("=" * 60)
    ...
    # Save results
    output_file = 'phase1_translated_schema.json'
    output_data = {
        'metadata': {
