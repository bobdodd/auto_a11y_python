#!/usr/bin/env python3
"""
Add ALL remaining French translations for help page based on visible English text
"""

TRANSLATIONS = {
    # Scoring section translations
    ...
    "If a page has no images, the images test will be marked as not applicable and won't affect your score.":
        "Si une page n'a pas d'images, le test des images sera marqué comme non applicable et n'affectera pas votre score.",
    ...
    # FAQ answers - these need to match the exact text
